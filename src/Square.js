...
function Square({row, column, attemp, textUpdate}) {
    ...
    return (
        <input className={backgroundCellColor} disabled={row != attempt ? "true" : false} type="text" 
        value={letter} onChange={handleInputLetter}></input>
    );
}
